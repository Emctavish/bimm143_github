...
```{r}
wisc.df <- read.csv(file="WisconsinCancer.csv", row.names = 1)
...
The main function here is `prcomp()` and we want to make sure we set the optional argyiment `scale=TRUE`:
